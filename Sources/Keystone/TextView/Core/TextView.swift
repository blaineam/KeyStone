...
open class TextView: UIScrollView {
    ...
    /// Set to true during text updates to prevent tokenizer crashes.
    public var isUpdatingText: Bool {
        get { textInputView.isUpdatingText }
        set { textInputView.isUpdatingText = newValue }
    }
    ...
    /// Use this instead of setting `text` directly when you want to sync text without clearing undo history.
