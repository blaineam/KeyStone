...
final class IndentController {
    ...
    init(stringView: StringView, lineManager: LineManager, languageMode: InternalLanguageMode, indentStrategy: IndentStrategy, indentFont: RunestoneFont) {
